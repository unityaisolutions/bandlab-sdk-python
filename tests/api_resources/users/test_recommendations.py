...
class TestRecommendations:
    ...
    def test_method_list_users(self, client: BandlabSDK) -> None:
        recommendation = client.users.recommendations.list_users(
            user_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(UserSummaryList, recommendation, path=["response"])
    ...
    def test_raw_response_list_users(self, client: BandlabSDK) -> None:
        response = client.users.recommendations.with_raw_response.list_users(
            user_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_list_users(self, client: BandlabSDK) -> None:
        with client.users.recommendations.with_streaming_response.list_users(
            user_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
    ...
    def test_path_params_list_users(self, client: BandlabSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `user_id` but received ''"):
            client.users.recommendations.with_raw_response.list_users(
                user_id="",
            )
...
class TestAsyncRecommendations:
    ...
    async def test_method_list_users(self, async_client: AsyncBandlabSDK) -> None:
        recommendation = await async_client.users.recommendations.list_users(
            user_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(UserSummaryList, recommendation, path=["response"])
    ...
    async def test_raw_response_list_users(self, async_client: AsyncBandlabSDK) -> None:
        response = await async_client.users.recommendations.with_raw_response.list_users(
            user_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_list_users(self, async_client: AsyncBandlabSDK) -> None:
        async with async_client.users.recommendations.with_streaming_response.list_users(
            user_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list_users(self, async_client: AsyncBandlabSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `user_id` but received ''"):
            await async_client.users.recommendations.with_raw_response.list_users(
                user_id="",
            )
