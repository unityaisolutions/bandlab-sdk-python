...
class TestImages:
    ...
    def test_method_create_post(self, client: BandlabSDK) -> None:
        image = client.images.create_post(
            image_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(Post, image, path=["response"])
    ...
    def test_raw_response_create_post(self, client: BandlabSDK) -> None:
        response = client.images.with_raw_response.create_post(
            image_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_create_post(self, client: BandlabSDK) -> None:
        with client.images.with_streaming_response.create_post(
            image_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
    ...
    def test_path_params_create_post(self, client: BandlabSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `image_id` but received ''"):
            client.images.with_raw_response.create_post(
                image_id="",
            )
...
class TestAsyncImages:
    ...
    async def test_method_create_post(self, async_client: AsyncBandlabSDK) -> None:
        image = await async_client.images.create_post(
            image_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(Post, image, path=["response"])
    ...
    async def test_raw_response_create_post(self, async_client: AsyncBandlabSDK) -> None:
        response = await async_client.images.with_raw_response.create_post(
            image_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_create_post(self, async_client: AsyncBandlabSDK) -> None:
        async with async_client.images.with_streaming_response.create_post(
            image_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_create_post(self, async_client: AsyncBandlabSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `image_id` but received ''"):
            await async_client.images.with_raw_response.create_post(
                image_id="",
            )
