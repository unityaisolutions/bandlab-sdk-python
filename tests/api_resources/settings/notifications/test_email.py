...
class TestEmail:
    ...
    def test_method_retrieve(self, client: BandlabSDK) -> None:
        email = client.settings.notifications.email.retrieve()
        assert_matches_type(SettingsEmail, email, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_retrieve(self, client: BandlabSDK) -> None:
        response = client.settings.notifications.email.with_raw_response.retrieve()
    ...
    def test_streaming_response_retrieve(self, client: BandlabSDK) -> None:
        with client.settings.notifications.email.with_streaming_response.retrieve() as response:
    ...
    def test_method_update(self, client: BandlabSDK) -> None:
        email = client.settings.notifications.email.update()
        assert_matches_type(SettingsEmail, email, path=["response"])
    ...
    def test_raw_response_update(self, client: BandlabSDK) -> None:
        response = client.settings.notifications.email.with_raw_response.update()
    ...
    def test_streaming_response_update(self, client: BandlabSDK) -> None:
        with client.settings.notifications.email.with_streaming_response.update() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncEmail:
    ...
    async def test_method_retrieve(self, async_client: AsyncBandlabSDK) -> None:
        email = await async_client.settings.notifications.email.retrieve()
        assert_matches_type(SettingsEmail, email, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_retrieve(self, async_client: AsyncBandlabSDK) -> None:
        response = await async_client.settings.notifications.email.with_raw_response.retrieve()
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncBandlabSDK) -> None:
        async with async_client.settings.notifications.email.with_streaming_response.retrieve() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_update(self, async_client: AsyncBandlabSDK) -> None:
        email = await async_client.settings.notifications.email.update()
        assert_matches_type(SettingsEmail, email, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncBandlabSDK) -> None:
        response = await async_client.settings.notifications.email.with_raw_response.update()
    ...
    async def test_streaming_response_update(self, async_client: AsyncBandlabSDK) -> None:
        async with async_client.settings.notifications.email.with_streaming_response.update() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
