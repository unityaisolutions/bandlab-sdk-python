# Bandlab SDK Python API library
...
pip install git+ssh://git@github.com/unityaisolutions/bandlab-sdk-python.git
```
...
```sh
# install from the production repo
pip install 'bandlab_sdk[aiohttp] @ git+ssh://git@github.com/unityaisolutions/bandlab-sdk-python.git'
```
...
These methods return an [`APIResponse`](https://github.com/unityaisolutions/bandlab-sdk-python/tree/main/src/bandlab_sdk/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/unityaisolutions/bandlab-sdk-python/tree/main/src/bandlab_sdk/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/unityaisolutions/bandlab-sdk-python/issues) with questions, bugs, or suggestions.
