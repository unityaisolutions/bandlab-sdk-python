...
from ...types.users import contact_list_bands_params, contact_list_users_params
from ..._base_client import make_request_options
from ...types.collections.user_summary_list import UserSummaryList
from ...types.users.contact_list_bands_response import ContactListBandsResponse
...
class ContactsResource(SyncAPIResource):
    ...
    def list_bands(
        ...
        *,
        ...
        return self._get(
            f"/users/{user_id}/contacts/bands",
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    contact_list_bands_params.ContactListBandsParams,
                ),
            ),
            cast_to=ContactListBandsResponse,
        )
    ...
    def list_users(
        ...
        *,
        ...
        if not user_id:
            raise ValueError(f"Expected a non-empty value for `user_id` but received {user_id!r}")
        return self._get(
            f"/users/{user_id}/contacts/users",
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                ...
                query=maybe_transform(
                    ...
                    contact_list_users_params.ContactListUsersParams,
                ),
            ),
