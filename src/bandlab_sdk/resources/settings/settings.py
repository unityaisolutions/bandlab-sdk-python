...
class SettingsResourceWithRawResponse:
    ...
    def notifications(self) -> NotificationsResourceWithRawResponse:
        return NotificationsResourceWithRawResponse(self._settings.notifications)
...
class AsyncSettingsResourceWithRawResponse:
    ...
    def notifications(self) -> AsyncNotificationsResourceWithRawResponse:
        return AsyncNotificationsResourceWithRawResponse(self._settings.notifications)
...
class SettingsResourceWithStreamingResponse:
    ...
    def notifications(self) -> NotificationsResourceWithStreamingResponse:
        return NotificationsResourceWithStreamingResponse(self._settings.notifications)
...
class AsyncSettingsResourceWithStreamingResponse:
    ...
    def notifications(self) -> AsyncNotificationsResourceWithStreamingResponse:
        return AsyncNotificationsResourceWithStreamingResponse(self._settings.notifications)
