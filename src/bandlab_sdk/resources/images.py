...
class ImagesResource(SyncAPIResource):
    ...
    def create_post(
        ...
        *,
        ...
        counters: image_create_post_params.Counters | Omit = omit,
        created_on: Union[str, datetime] | Omit = omit,
        creator: CreatorParam | Omit = omit,
        image: image_create_post_params.Image | Omit = omit,
        message: str | Omit = omit,
        revision: image_create_post_params.Revision | Omit = omit,
        type: Literal["Revision", "Image", "Video", "Text"] | Omit = omit,
        video: image_create_post_params.Video | Omit = omit,
